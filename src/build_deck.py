...
def build():
  ...
  <div class="three">
    <div class="feat">
      ...
      <h3>Аудит сметы</h3>
      <p>Сверяет распознанные позиции с рыночными коридорами по 47 типам работ,
      о чём спросить подрядчика</p>
      <div class="st">закрывает страх переплаты</div>
    </div>
    <div class="feat">
      <div class="fi" style="color:var(--ok)">Фича 2 · R&amp;D-прототип</div>
      <h3>Рейтинг мастера</h3>
      <p>Профиль подрядчика по девяти сторонам вместо одной звезды, собранный
      из текста отзывов</p>
      <div class="st" style="color:var(--warm)">тональность работает, аспекты — нет</div>
    </div>
    <div class="feat">
  ...
  <div class="cols" style="margin-top:24px">
    <div>
      <div class="demo">
        ...
        <div class="row total"><span>Выше медианного ориентира на</span>
    ...
    <div>
      <div class="moat">
        ...
        <p>Ров не в самих ценах — источники публичные. Ров в <b>нормализаторе</b>,
        который сводит тысячи разных названий к 47 работам, и в <b>истории версий
        смет</b>, которая появляется только внутри платформы</p>
      </div>
      <ul style="margin-top:20px">
        <li class="ok"><b>Окупает подписку с первой сметы:</b> расхождение с рынком на 82 тысячи
        против 790 ₽/мес</li>
  ...
  <div class="evid">
    ...
    <span class="e"><b>6 391</b> цена собрана скраперами, <b>2 369</b> прошли очистку</span>
    <span class="e"><b>22</b> компании в проверке на незнакомых данных</span>
    <span class="e" style="color:var(--faint)">детали метрик — на слайде «зрелость»</span>
  </div>"""))

    # 3 — фича 2
    P.append(slide(3, """
  <span class="tag o">Фича 2 · R&amp;D-прототип</span>
  <h2 class="sm">Репутация, устойчивая к накрутке</h2>
  <div class="before">
    <div class="ba was">
      <div class="t">Было</div>
  ...
  <div class="cols wide" style="margin-top:20px">
    ...
    <div>
      ...
      <ul style="margin-top:20px">
        ...
        <li class="warm"><b>Статус честно:</b> тональность отзыва подтверждена, а привязка
        фразы к аспекту даёт 0.51 — <b>quality gate не пройден, в продукт не выпущено</b></li>
        <li class="warm"><b>Рейтинг на событиях сделки</b> — спроектирован, в этом
        репозитории не реализован</li>
      </ul>
    </div>
  </div>
  <div class="evid">
    ...
    <span class="e"><b>0.96</b> против <b>0.87</b> — но это тональность отзыва целиком,
    разметка выведена из звёзд</span>
    <span class="e" style="color:var(--warm)">аспекты: <b>0.51</b> — не выпущено</span>
  ...
  <div class="evid">
    <span class="cap">Доказательство</span>
    <span class="e"><b>82%</b> верно определён тип события</span>
    <span class="e">ни одной ложной карточки на демо-корпусе</span>
    <span class="e" style="color:var(--warm)">синтетический сценарий, <b>n = 45</b> сообщений</span>
  </div>"""))
  ...
  <div class="cols wide" style="margin-top:18px">
    ...
    <div>
      <ul>
        ...
        простые методы оказались точнее</li>
        <li class="warm"><b>Проверил ещё строже.</b> На знакомых данных модель бьёт медиану
        (38.7% против 43.6%), но <b>на новой компании — уже нет</b> (44.0% против 43.5%).
        Поэтому в интерфейсе показываем объяснимые рыночные коридоры, а не предсказание модели</li>
        <li><b>Что не выпустил:</b> аспектный рейтинг и поиск по договорам — quality gate
        не пройден</li>
      </ul>
      <div class="quote ok">Моя задача — не максимизировать сложность ML, а выпускать только
      то, чья польза подтверждена</div>
      <div class="evid" style="margin-top:26px">
        <span class="cap">Инженерия</span>
        <span class="e"><b>68</b> автотестов и CI</span>
        <span class="e"><b>2 369</b> цен + <b>1 212</b> отзывов собрано скраперами</span>
      </div>
    </div>
